...
function openFolder(id){
  ...
  const media=items.map((x,i)=>`<article class="viewer-item">
    <div class="viewer-media">${x.type==='video'
      ...
      : x.type==='pdf'
        ? `<div class="viewer-pdf"><object data="${esc(x._src||x.src)}" type="application/pdf"><embed src="${esc(x._src||x.src)}" type="application/pdf"></embed><span>PDF preview is not supported by this browser.</span></object></div>`
